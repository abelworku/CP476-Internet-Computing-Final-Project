...
<html lang="en">
    <head>
        ...
        <title>Your Wish List | Whimsy</title> 
        ...
        <div class="container-fluid bg-white">
            ...
            <div class="mainContainer">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <h5 class="font-weight-light display-4">
                            ...
                            if (count($allWishList) == 0) { 
                                echo "0 items";
                            } else if (count($allWishList) == 1) {    
                                echo "1 item"; 
                            } else { 
                                echo count($allWishList) . " items";
                    ...
                    <div class="col-sm-12 col-md-6">
                        <a class="btn btn-dark btn-outline-light mt-3 px-3 py-2 float-right" href="../PHP/removeItemFromWishList.php">
                            Clear All
                        </a>
                    </div>
                ...
                <div class="row row-cols-1 row-cols-sm-1 row-cols-md-4 row-cols-lg-8 mt-5">
                    ...
                    if (count($allWishList) == 0) { 
                            ...
                            echo "<h5 class='py-3 pl-1 font-weight-light'>&middot; You don't have any items in your wish list yet, we can fix that by exploring what Whimsy has to offer by looking through our <a href='../HTML/Shop.php'>catalogue</a>!</h5>";
                            echo "</div>";    
                        
                    } else { 
                    
                        foreach($allWishList as $itemRow) { 
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-5">
                                                <a class="btn btn-dark btn-outline-light px-3 py-2 float-right" href="../PHP/removeItemFromWishList.php?productID=<?php echo $row['ProductID']; ?>">
                                                    Remove
                                                </a>
                                            </div>
                                        </div>
            ...
            <script>
                $(document).ready(function() { 
                    ...
                    $("#headerWishListLink").addClass("active");
                });
